    ...
    return(
        <div className={classes.featured}>
            ...
            <section className={classes.section}>
                ...
                <Card imgUrl="/images/newarrivals/products_2FP13-104147-CC-MC5-0353369_2FP13-104147-CC-MC5-0353369_1680587600690_158x158_crop_bottom.avif" name='PRS CE24' price={+3200}/>
            </section>
        </div>
    )
}
